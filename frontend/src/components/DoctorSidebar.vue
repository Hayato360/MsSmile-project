  ...
  <aside class="sidebar">
    <div class="logo-container">
      ...
      <div class="logo-text">
        ...
        <span class="app-subtitle">ระบบแพทย์</span>
      </div>
    </div>

    <div class="user-profile">
      <div class="avatar">
        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Doctor" alt="Doctor Avatar" />
        <div class="status-dot"></div>
      </div>
      <div class="user-info">
        <h3>{{ authStore.user?.full_name || 'แพทย์' }}</h3>
        <p class="role-badge">แพทย์</p>
      </div>
    </div>
